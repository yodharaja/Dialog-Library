...
public class PermissionRequestDialog {
    ...
    public static void show(Context context, final OnPermissionDecisionListener listener) {
        View view = LayoutInflater.from(context).inflate(R.layout.dialog_permission_request, null);

        MaterialButton btnCancel = view.findViewById(R.id.dialog_btn_cancel);
        MaterialButton btnGrant = view.findViewById(R.id.dialog_btn_grant);
