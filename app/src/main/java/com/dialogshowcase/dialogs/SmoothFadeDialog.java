...
public class SmoothFadeDialog {
    ...
    public static void show(Context context, final OnDismissListener listener) {
        View view = LayoutInflater.from(context).inflate(R.layout.dialog_anim_fade, null);

        MaterialButton btnDismiss = view.findViewById(R.id.btn_fade_dismiss);
        MaterialButton btnConfirm = view.findViewById(R.id.btn_fade_confirm);
