...
public class SweetQuestionDialog {
    ...
    public static void show(Context context, String title, String message, final OnDecisionListener listener) {
        View view = LayoutInflater.from(context).inflate(R.layout.dialog_sweet_question, null);
