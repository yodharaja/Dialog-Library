...
public class SweetInfoDialog {

    public interface OnDismissListener {
        void onDismiss();
    }

    public static void show(Context context, String title, String message, final OnDismissListener listener) {
        View view = LayoutInflater.from(context).inflate(R.layout.dialog_sweet_info, null);
